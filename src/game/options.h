...
/* RC5 adds a sixth logical page without resizing the player-struct-backed
 * five-page geometry buffers.  The mod build draws six selector rectangles
 * dynamically while preserving the retail player layout. */
#define WATCH_LOGICAL_PAGE_COUNT 6
#endif
...
#ifdef GE_MODDED_CHEATS
/* R21 multiplayer player-options bitfield.  These are session-local just like
 * the original multiplayer Health/Control Style selections, but unlike the
 * old combined Aim preset every participating player owns an independent
 * copy. */
#define MP_PLAYEROPT_LOOK        0x01
#define MP_PLAYEROPT_AUTOAIM     0x02
#define MP_PLAYEROPT_AIMCONTROL  0x04
#define MP_PLAYEROPT_SIGHT       0x08
#define MP_PLAYEROPT_LOOKAHEAD   0x10
#define MP_PLAYEROPT_AMMO        0x20
#define MP_PLAYEROPT_HEADROLL    0x40
#define MP_PLAYEROPT_DAMAGE_SFX  0x80
#define MP_PLAYEROPT_DEFAULT     (MP_PLAYEROPT_AUTOAIM | MP_PLAYEROPT_SIGHT | MP_PLAYEROPT_LOOKAHEAD | MP_PLAYEROPT_AMMO | MP_PLAYEROPT_HEADROLL | MP_PLAYEROPT_DAMAGE_SFX)
